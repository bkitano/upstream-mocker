# has to be absolute path, not relative path
...
python3 impose_video.py $1 ./outputs/imposer.avi
python3 recorder.py ./outputs/mover.avi 10 1 10 & python3 move_cursor_to_popup.py
sleep 15
python3 stitch.py ./outputs/opener.avi ./outputs/mover.avi ./outputs/imposer.avi $2
rm -f ./outputs/*